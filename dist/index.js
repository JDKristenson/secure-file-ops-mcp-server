...
import { SecureReadFileInputSchema, SecureWriteFileInputSchema, ValidateApiDestinationInputSchema, ScanForInjectionInputSchema, RequestApprovalInputSchema, CheckApprovalInputSchema, ApproveOperationInputSchema, SetAccessPolicyInputSchema, QueryAuditLogInputSchema, GetSecurityAlertsInputSchema, AcknowledgeAlertInputSchema } from './schemas/index.js';
import { scanForInjection, validateApiDestination, queryAuditLog, getSecurityAlerts, acknowledgeAlert, addAuditEntry } from './services/security.js';
import { createApprovalRequest, getApprovalRequest, processApproval } from './services/approval.js';
import { secureReadFile, secureWriteFile, setAccessPolicy } from './services/fileops.js';
...
// ============================================================================
server.registerTool("secure_read_file", {
...
// ============================================================================
server.registerTool("secure_write_file", {
...
// ============================================================================
server.registerTool("validate_api_destination", {
...
Use this before any external API calls that handle sensitive data.`,
    ...
    const result = validateApiDestination(params.destination_url, params.destination_api_key, params.source_api_key);
    // Log the validation
    addAuditEntry({
        operation: 'api_call',
...
// ============================================================================
server.registerTool("scan_for_injection", {
...
Returns:
  ...
  - expiresAt: When the request will auto-deny`,
    ...
    const request = createApprovalRequest(params.operation, params.description, params.details, params.timeout_seconds * 1000);
    if (params.response_format === ResponseFormat.JSON) {
        return {
...
// ============================================================================
server.registerTool("check_approval_status", {
...
// ============================================================================
server.registerTool("approve_operation", {
...
// ============================================================================
server.registerTool("set_access_policy", {
...
Returns the updated policy configuration.`,
    ...
    const policy = setAccessPolicy(update);
    const result = {
...
// ============================================================================
server.registerTool("security_alerts", {
...
// ============================================================================
server.registerTool("acknowledge_alert", {
