...
const quarantinedContent: Map<string, { content: string; source?: string; timestamp: Date }> = new Map();
...
export function scanForInjection(
  content: string,
  source?: string,
  quarantineIfDetected: boolean = true
): InjectionScanResult {
 ...
 */
export function validateApiDestination(
 ...
 */
export function scanForSensitiveData(content: string): string[] {
 ...
 */
export function createSecurityAlert(alert: Omit<SecurityAlert, 'id' | 'timestamp' | 'acknowledged'>): SecurityAlert {
  const fullAlert = {
    id: randomUUID(),
    timestamp: new Date(),
    acknowledged: false,
 ...
 */
export function getQuarantinedContent(quarantineId: string): { content: string; source?: string; timestamp: Date } | undefined {
 ...
 */
export function clearQuarantinedContent(quarantineId: string): boolean {
